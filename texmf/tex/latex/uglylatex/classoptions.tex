...
% 2025/03/18 Class options procesessing for the document class.
...
% Color theme of the document. The default color is `black'.
...
% Use fontawsome for admonition blocks.

\DeclareStringOption[true]{usefa}
\DeclareVoidOption{dousefa}{\kvsetkeys{UGLY}{usefa=true}}
\DeclareVoidOption{notusefa}{\kvsetkeys{UGLY}{usefa=false}}
...
% Use STEM-related packages (tikz, pgfplots, chemfig, etc.)
\DeclareBoolOption[false]{stem}

% Use biblatex for bibliography (default: enabled).
