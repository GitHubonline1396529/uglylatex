...
%
% Changing the language context will change the guide words for chart
% titles (graphs, tables); article structure words, such as the `table of
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Unfinished modules under construction.
% 
